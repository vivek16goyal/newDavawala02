...
function onDeviceReady() {
    ...
    if (APPType == "@") {
        ...
        try {
            if (HomeSlideCnt == "1") {
                //comented by vivek for changing the image 
               $("#HomeSlider-div").html("<ul  id='sliderFrame' style='display: none' > <li id='slide-1'>" +
                                        "<img src='assets/img/OZOCHECK.jpg>" +
                                       "</li></ul>");
...
//this discount will not work for the davawala as they dont have the latest webser  
//function discount()
//{
